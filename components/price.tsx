...
export const Price = ({
  ...
  return (
    <div className="flex flex-row gap-2 mt-2">
      <div className="flex items-center gap-2 h-fit bg-[#73c47e]/50 rounded-sm w-fit p-1 text-green-800 font-bold border-2 border-black">
      ...
      <div className="flex items-center h-fit gap-2 bg-[#73c47e]/50 rounded-sm w-fit p-1 text-green-800 font-bold border-2 border-black">
